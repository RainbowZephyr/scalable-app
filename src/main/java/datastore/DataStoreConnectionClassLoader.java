...
public class DataStoreConnectionClassLoader extends ClassLoader {
    /**
     * This constructor is used to set the parent ClassLoader
     */
    public DataStoreConnectionClassLoader(ClassLoader parent) {
        super(parent);
    }
    ...
    public Class<?> loadClass(String name) throws ClassNotFoundException {
        if (name.startsWith("datastore.datastores")) {
