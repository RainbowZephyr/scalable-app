...
public class SocketConnectionToController implements SocketConnection, Runnable{
    ...
    private final String appInstanceConfPath = "config/apps_instances.properties";
    private final String messageQueueConfPath = "config/message_queue_server.properties";
