...
my @sql_files = ["schema.sql","users_insertions.sql","post_insertions.sql", "group_insertions.sql", "friends_insertions.sql", "message_insertions.sql", "user_procs.sql", "group_procedures.sql", "post_procs.sql"];
