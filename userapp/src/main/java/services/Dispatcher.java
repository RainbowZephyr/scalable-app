...
public class Dispatcher {
    ...
    protected void loadDataStoreConnections() throws IOException, ClassNotFoundException {
        Properties prop = new Properties();
        InputStream in = new FileInputStream("userapp/config/data_store.properties");
        prop.load(in);
        in.close();
        Enumeration enumKeys = prop.propertyNames();
        String strClassKey,
    ...
    public void init() throws IOException, ClassNotFoundException {
        ...
        loadCommands(_htblCommands, "userapp/config/commands.properties");
        loadCommands(_adminHtblCommands, "userapp/config/admin_commands.properties");
